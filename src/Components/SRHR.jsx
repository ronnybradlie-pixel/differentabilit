...
const SRHR = () => {
    ...
    return (
        <div className="min-h-screen bg-white font-sans">
            ...
            <section className="py-26 px-6 md:px-24 max-w-6xl mx-auto text-lg leading-relaxed space-y-6">
               <p className="text-black text-2xl leading-relaxed font-light border-l-2 pl-8">We recognize that access to Sexual and Reproductive Health (SRH) is a fundamental human right. However, for persons with disabilities living in informal settlements, this right is often denied due to deeply rooted inequalities, stigma, and systemic barriers.
