...
const Advocacy = () => {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="py-24 px-6 md:px-24 max-w">
        <div >
         <p className="text-black text-2xl leading-relaxed font-light opacity-90 border-l-2 border-[oklch(28.2%_0.091_267.935)]/30 pl-8">
            ...
            We actively engage in national and community-level processes, contributing to conversations and actions that promote the inclusion of assistive devices, equitable healthcare access, and protection from violence and discrimination. </p>
            
            <p className="text-black text-2xl leading-relaxed font-light opacity-90 border-l-2 border-[oklch(28.2%_0.091_267.935)]/30 pl-8">We also prioritize grassroots advocacy, empowering individuals with disabilities to become self-advocates and community champions. By building their capacity, confidence, and leadership, we create a ripple effect where 
            advocacy is driven by lived experiences and real community needs.
