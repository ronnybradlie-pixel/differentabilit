    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="py-24 px-6 md:px-24 max-w-5xl mx-auto">
        <div className="border-l-4 border-purple-700 pl-8 space-y-6 text-lg md:text-xl leading-relaxed text-black opacity-90">
          <p>Advocacy is the foundation upon which we challenge systemic barriers, influence policy, and transform societal attitudes. We approach advocacy as both a rights-based and people-centered process. We work to ensure that the voices of persons with disabilities, especially women and girls are not only heard but actively shape the decisions that affect their lives.</p>
          <p>Our advocacy pillar focuses on influencing systems and structures, including healthcare, education, and social protection, to become more responsive and inclusive.</p>
        </div>
      </section>
    </div>
  );
