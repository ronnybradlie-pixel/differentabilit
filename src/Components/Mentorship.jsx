...
const Mentorship = () => {
    ...
    <div className="min-h-screen bg-white">
        ...
        <section className="pt-32 pb-20 px-6 md:px-24 bg-pink-50">
           <div className="max-w-6xl mx-auto flex flex-col md:flex-row-reverse gap-12 items-center">
            <div className="w-full md:w-1/2">
              <h1 className="text-4xl md:text-5xl font-black text-[#2d0a50] uppercase mb-6">Mentorship and Peer Learning</h1>
              <p className="text-xl text-gray-700 leading-relaxed font-bold">Mentorship and peer learning are essential components of our approach to supporting children with disabilities.</p>
              </div>
              <div className="w-full md:w-1/2">
                <img src={MentorshipImg} alt="Mentorship" className="rounded-3xl shadow-2xl h-[400px] w-full object-cover" />
              </div>
             </div>
            </section>      
      ...
      <section className="pt-32 pb-20 px-6 md:px-24">
        <h1 className="text-4xl md:text-6xl font-black text-purple-700 uppercase mb-8">Mentorship & Peer Learning</h1>
        <div>
            ...
            Through mentorship, DAI is shaping a generation of empowered children with disabilities who are confident, included, and equipped to explore their talents, pursue opportunities, and fully participate in society.</p>
